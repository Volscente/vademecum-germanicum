...
def test_get_senses_returns_list_with_word_fields(auth_client, valid_word_payload):
    """
    ...
    response = auth_client.get("/senses/")
...
def test_get_senses_returns_list(auth_client):
    """
...
def test_update_sense_review_success(auth_client, valid_word_payload):
    """
    ...
    the sent value.
    """
    create_response = auth_client.post("/words/", json=valid_word_payload)
...
def test_update_sense_review_invalid_difficulty(auth_client, valid_word_payload):
    """
...
def test_update_sense_review_not_found(auth_client):
    """
